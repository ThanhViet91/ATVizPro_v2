...
public class GuidelineFacebookLiveStreamingFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        tvTitle.setText(getString(R.string.facebook_livestreaming));
        TextView tvDes = view.findViewById(R.id.tv_decs);
        tvDes.setText(getString(R.string.description_fb_live));

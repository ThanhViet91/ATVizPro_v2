//package com.examples.atscreenrecord_test.controllers.encoder;
//
//
...
//
//import com.examples.atscreenrecord_test.controllers.encoder.RenderUtil.CustomDecorator;
//import com.examples.atscreenrecord_test.controllers.settings.VideoSetting;
...
//
//public class CameraEncoder extends MediaVideoEncoderBase {
//	private static final String TAG = CameraEncoder.class.getSimpleName();
//
...
//
//	public CameraEncoder(MediaMuxerWrapper muxer, MediaEncoderListener listener, MediaProjection projection,
//						 VideoSetting videoSetting, int density, List<CustomDecorator> decorators) {

package com.examples.atscreenrecord_test.controllers.settings;
...
//    public static VideoSetting VIDEO_PROFILE_SD = new VideoSetting(480, 360, 30, 1000 * 1024, ORIENTATION_LANDSCAPE);
    public static VideoSetting VIDEO_PROFILE_SD = new VideoSetting(640, 360, 30, 1200 * 1024, ORIENTATION_LANDSCAPE);

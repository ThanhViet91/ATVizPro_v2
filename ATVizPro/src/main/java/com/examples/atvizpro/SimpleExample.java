...
public class SimpleExample extends AppCompatActivity {
	...
	public class TranscdingBackground extends AsyncTask<String, Integer, Integer>
	{
		...
		protected Integer doInBackground(String... paths) {
			...
			String mainVideoPath = "/sdcard/videomain.mp4";
			String time = new SimpleDateFormat("yyyyMMdd_HHmmss").format(new Date());
			String mixVideoPath = "/sdcard/thanhtest"+ time +".mp4";
			String command = "ffmpeg -i "+ mainVideoPath +" -i "+mainVideoPath+" -filter_complex [0]scale=300:-1[overlay];[1][overlay]overlay=x=main_w-overlay_w:y=0;[0:a][1:a]amix -preset ultrafast "+mixVideoPath;
			...
			try {
				...
				vk.run(GeneralUtils.utilConvertToComplex(command), workFolder, getApplicationContext());

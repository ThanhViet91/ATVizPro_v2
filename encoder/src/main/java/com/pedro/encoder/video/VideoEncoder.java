...
//        System.out.println("thanh =====> VideoEncoder --- "+encoder.getName());
  ...
  public void inputYUVData(Frame frame) {
    if (running && !queue.offer(frame)) {  //thêm frame vào cuối queue, nếu queue đã đầy thì trả ra false
  ...
  protected Frame getInputFrame() throws InterruptedException {
    Frame frame = queue.take();   // lấy frame từ đầu queue ra ngoài, nếu queue rỗng thì đợi để lấy, len--
